...
<script>
 ...
 `;
    ...
    register_form.addEventListener('submit', function(e) {
        ...
        data.append('post_num', register_form.elements['post_num'].value);
        ...
        xhr.onload = function() {
            ...
            if (this.responseText == 'pass_mismatch') {
                ...
                alert('danger', 'Eposten er allerede i bruk');
                ...
                alert('success', 'Epost sendt');
            } else if (this.responseText == 'success') {
                alert('success', 'Registrering vellykket. Kontroll eposten din for å bekrefte kontoen');
                register_form.reset();
            } else {
                alert('danger', 'Noe gikk galt. Vennligst prøv igjen');
            }
