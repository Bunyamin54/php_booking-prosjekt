...
<body class="bg-light">
 ...
 <!-- //? javascript og jquery -->
  ...
  <script>
    $(function() {
      $('#checkInDatePicker').datepicker({ showButtonPanel: true, dateFormat: 'dd-mm-yy' }).datepicker("setDate", new Date());
      $('#checkOutDatePicker').datepicker({ showButtonPanel: true, dateFormat: 'dd-mm-yy' }).datepicker("setDate", new Date());
      $('#birthDatePicker').datepicker({ showButtonPanel: true, dateFormat: 'dd-mm-yy' }).datepicker("setDate", new Date());
    });
